...
export const modules: Module[] = [
  {
    ...
    flows: 12,
    status: "active",
    integrations: ["Google Calendar", "WhatsApp", "API Routes"],
    color: "bg-blue-500",
  ...
  },
  {
    ...
    flows: 6,
    status: "active",
    integrations: ["Prefeitura SP", "Receita Federal", "API Routes"],
    color: "bg-purple-500",
  ...
  },
  {
    ...
    flows: 5,
    status: "active",
    integrations: ["Stripe", "PagSeguro", "Pix", "API Routes"],
    color: "bg-green-500",
  ...
  },
  {
    ...
    templates: 8,
    status: "active",
    integrations: ["WhatsApp Business API", "API Routes", "MSG-ROUTER"],
  ...
  },
  {
    ...
    flows: 5,
    status: "active",
    integrations: ["Supabase", "API Routes"],
    color: "bg-orange-500",
  ...
  },
  {
    ...
    flows: 6,
    status: "planned",
    integrations: ["WhatsApp", "Email", "API Routes"],
    color: "bg-pink-500",
